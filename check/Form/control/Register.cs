...
namespace check
{
    public partial class Register : Form
    {
        ...
        {
            if (texUsername.Text == "" || textPassword.Text == "" || textConfirm.Text == "")
            {
                MessageBox.Show("Please enter correct format", "REGISTER", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
